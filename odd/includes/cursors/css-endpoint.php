...
function odd_cursors_build_css( array $set ) {
	...
	return implode(
		...
		array(
			...
			'[data-window-id], [data-windowid], [data-wp-desktop-window-id], [data-desktop-window-id], [data-native-window-id], .desktop-mode-window, .wp-desktop-window, .desktop-window { cursor: var(--odd-cursor-default); }',
			...
			'.desktop-mode-window [data-window-chrome], .desktop-mode-window [data-window-titlebar], .wp-desktop-window [data-window-chrome], .wp-desktop-window [data-window-titlebar], .desktop-window [data-window-chrome], .desktop-window [data-window-titlebar], .desktop-mode-window__titlebar, .wp-desktop-window__titlebar, .desktop-window__titlebar, .window-titlebar, .native-window-titlebar { cursor: var(--odd-cursor-grab); }',
			'.desktop-mode-window button, .wp-desktop-window button, .desktop-window button, .desktop-mode-window [role="button"], .wp-desktop-window [role="button"], .desktop-window [role="button"], .desktop-mode-window [aria-label="Minimize"], .desktop-mode-window [aria-label="Maximize"], .desktop-mode-window [aria-label="Restore"], .desktop-mode-window [aria-label="Close"], .wp-desktop-window [aria-label="Minimize"], .wp-desktop-window [aria-label="Maximize"], .wp-desktop-window [aria-label="Restore"], .wp-desktop-window [aria-label="Close"], .desktop-window [aria-label="Minimize"], .desktop-window [aria-label="Maximize"], .desktop-window [aria-label="Restore"], .desktop-window [aria-label="Close"] { cursor: var(--odd-cursor-pointer); }',
			'[data-odd-cursor="default"] { cursor: var(--odd-cursor-default); }',
			'[data-odd-cursor="pointer"] { cursor: var(--odd-cursor-pointer); }',
			'[data-odd-cursor="text"] { cursor: var(--odd-cursor-text); }',
			'[data-odd-cursor="grab"] { cursor: var(--odd-cursor-grab); }',
