 ...
 * `odd_catalog_load()` has no fresh transient and no stale mirror
...
if ( ! defined( 'ODD_CATALOG_FALLBACK_PATH' ) ) {
	define( 'ODD_CATALOG_FALLBACK_PATH', ODD_DIR . 'data/fallback-registry.json' );
}
 ...
 */
function odd_catalog_fallback_path() {
	return (string) apply_filters( 'odd_catalog_fallback_path', ODD_CATALOG_FALLBACK_PATH );
}
 ...
 */
function odd_catalog_fallback_load() {
	static $cached = null;
	if ( null !== $cached ) {
		return $cached;
	}
	...
	if ( function_exists( 'odd_catalog_normalise' ) ) {
		$cached = odd_catalog_normalise( $data );
	} else {
		$cached = $empty;
	}
	return $cached;
 ...
 */
function odd_catalog_fallback_available() {
