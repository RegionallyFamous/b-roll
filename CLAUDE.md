...
- **Live demo (stable, ODD 1.0.4):** Hosted blueprint [`site/playground/blueprint.json`](https://odd.regionallyfamous.com/playground/blueprint.json?oddbp=v2-1.0.4) or short redirect [`/go/`](https://odd.regionallyfamous.com/go/) → Playground — pins Desktop Mode **0.8.0** zip + ODD **v1.0.4** release ref (`?oddbp=` avoids stale blueprint caching). Raw GitHub: [`blueprint.json`](https://raw.githubusercontent.com/RegionallyFamous/odd/main/blueprint.json?oddbp=v2-1.0.4). **Dev / trunk (bleeding edge, not release-track):** [`blueprint-dev.json`](https://github.com/RegionallyFamous/odd/blob/main/blueprint-dev.json) / hosted [`blueprint-dev.json`](https://odd.regionallyfamous.com/playground/blueprint-dev.json?oddbp=dev-dm-0.8.0) — Desktop Mode **0.8.0** from WP.org (pinned zip) + ODD **`main`** from GitHub; short redirect [`/go/dev`](https://odd.regionallyfamous.com/go/dev/) and launcher [`/playground/dev/`](https://odd.regionallyfamous.com/playground/dev/).
