...
1. Open `https://odd.regionallyfamous.com/playground/` (stable: ODD **1.0.6** + Desktop Mode **0.8.0**). For trunk, use [`/playground/dev/`](https://odd.regionallyfamous.com/playground/dev/) instead — **do not** use the stable URL to validate `main`.
