...
( function () {
	...
	if ( window.__bRoll.eggs && window.__bRoll.eggs._installed ) return;
	...
	function dispatch( name ) {
		...
		var scene = ( window.__bRoll.scenes || {} )[ state.activeSlug ];
		...
		try {
			...
			if ( window.console ) window.console.warn( 'B-Roll: egg handler threw', name, e );
		}
	}
