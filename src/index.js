...
( function () {
	...
	PREVIEWS[ 'code-rain' ] = preview( [
		"<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 160 100' preserveAspectRatio='xMidYMid slice'>",
			"<defs>",
				"<radialGradient id='bg' cx='.5' cy='.45' r='.85'>",
					"<stop offset='0' stop-color='#062a15'/><stop offset='1' stop-color='#000'/>",
				"</radialGradient>",
				"<filter id='g' x='-40%' y='-40%' width='180%' height='180%'><feGaussianBlur stdDeviation='2.2'/></filter>",
				"<pattern id='sc' width='4' height='4' patternUnits='userSpaceOnUse'><rect width='4' height='1' fill='#000'/></pattern>",
			"</defs>",
			"<rect width='160' height='100' fill='url(#bg)'/>",
			"<g font-family='ui-monospace,monospace' font-size='10' text-anchor='middle'>",
				"<g transform='translate(20)'>",
					"<text y='14' fill='#003818' opacity='.6'>ア</text>",
					"<text y='28' fill='#006b2b'>カ</text>",
					"<text y='42' fill='#00a441'>ミ</text>",
					"<text y='56' fill='#00ff66' opacity='.55' filter='url(#g)'>W</text>",
					"<text y='56' fill='#fff'>W</text>",
				"</g>",
				"<g transform='translate(44)'>",
					"<text y='10' fill='#003818' opacity='.5'>0</text>",
					"<text y='24' fill='#006b2b'>1</text>",
					"<text y='38' fill='#00a441'>W</text>",
					"<text y='52' fill='#00d452'>サ</text>",
					"<text y='66' fill='#00ff66' opacity='.55' filter='url(#g)'>タ</text>",
					"<text y='66' fill='#eaffdc'>タ</text>",
				"</g>",
				"<g transform='translate(68)'>",
					"<text y='20' fill='#006b2b' opacity='.7'>ヒ</text>",
					"<text y='34' fill='#00a441'>ネ</text>",
					"<text y='48' fill='#00d452'>W</text>",
					"<text y='62' fill='#00ff66'>ラ</text>",
					"<text y='76' fill='#00ff66' opacity='.5' filter='url(#g)'>ホ</text>",
					"<text y='76' fill='#eaffdc'>ホ</text>",
				"</g>",
				"<g transform='translate(92)'>",
					"<text y='15' fill='#003818' opacity='.5'>W</text>",
					"<text y='29' fill='#006b2b'>ヌ</text>",
					"<text y='43' fill='#00a441'>エ</text>",
					"<text y='57' fill='#00d452'>4</text>",
					"<text y='71' fill='#00ff66' opacity='.55' filter='url(#g)'>W</text>",
					"<text y='71' fill='#eaffdc'>W</text>",
				"</g>",
				"<g transform='translate(116)'>",
					"<text y='24' fill='#006b2b'>キ</text>",
					"<text y='38' fill='#00a441'>0</text>",
					"<text y='52' fill='#00d452'>W</text>",
					"<text y='66' fill='#00ff66' opacity='.55' filter='url(#g)'>ム</text>",
					"<text y='66' fill='#eaffdc'>ム</text>",
				"</g>",
				"<g transform='translate(140)'>",
					"<text y='12' fill='#003818' opacity='.6'>ヨ</text>",
					"<text y='26' fill='#006b2b'>チ</text>",
					"<text y='40' fill='#00a441'>W</text>",
					"<text y='54' fill='#00ff66' opacity='.55' filter='url(#g)'>レ</text>",
					"<text y='54' fill='#eaffdc'>レ</text>",
				"</g>",
			"</g>",
			"<rect width='160' height='100' fill='url(#sc)' opacity='.12'/>",
		"</svg>",
	].join( '' ), '#000' );
